...
public class ApplicatoinContextSameBeanFindTest {
    ...
    void findBeanFindByTypeDuplicate(){
//        ac.getBean(MemberRepository.class); // memberRepository 가 2개있어서 예외가 터져버림.
        assertThrows(NoUniqueBeanDefinitionException.class, () -> ac.getBean(MemberRepository.class));
    }

    @Test
    @DisplayName("타입으로 조회시 같은 같은 타입이 둘 이상 있으면, 빈 이름을 지정하면 된다.")
    void findBeanByName(){
