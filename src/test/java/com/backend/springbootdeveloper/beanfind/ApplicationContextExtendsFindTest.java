...
public class ApplicationContextExtendsFindTest {
    ...
    void findBeanByParentTypeBeanName(){
        ...
        assertThat(rateDiscountPolicy).isInstanceOf(RateDiscountPolicy.class);// 빈 이름으로 지정.
    }
    ...
    void findAllBeanByObjectType(){
        Map<String, Object> beansOfType = ac.getBeansOfType(Object.class); // object 로 조회시 스프링 내부에서 쓰는 빈까지 조회해버린다.
